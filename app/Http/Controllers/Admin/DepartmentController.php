...
class DepartmentController extends Controller
{
    // List all departments - FIXED VERSION (no slug, no color, no is_active)
    public function index()
    {
        try {
            // Simple query to get departments - only use columns that exist
            // Based on your model, you only have: id, name, description
